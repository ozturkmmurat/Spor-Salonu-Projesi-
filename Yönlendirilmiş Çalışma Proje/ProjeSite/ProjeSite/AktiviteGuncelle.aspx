<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AktiviteGuncelle.aspx.cs" Inherits="ProjeSite.SporBolumuGuncelle" %>
...
<div id="form-main">
  ...
  <div class="upload-options">
      ...
      <button style="margin-top:10px; margin-left:auto;" runat="server" id="btnSporBolumuGuncelle"  type="button" onserverclick="btnSporBolumuGuncelle_ServerClick" class="btn btn-outline-secondary">Güncelle</button>
