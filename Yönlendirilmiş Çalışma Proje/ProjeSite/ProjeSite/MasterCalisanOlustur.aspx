<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="MasterCalisanOlustur.aspx.cs" Inherits="ProjeSite.Sayfalar.MasterCalisanOlustur" %>
...
<div id="form-main">
  ...
  <div class="upload-options">
    ...
    <input  runat="server" name="name" type="text" class="validate[required,custom[onlyLetter],length[0,100]] feedback-input" placeholder="Tel" id="Calisan_Tel" />
       ...
       <asp:TextBox  ID="Txt_Calisan_DogumTarih" CssClass="validate[required,custom[onlyLetter],length[0,100]] feedback-inputdeneme"  runat="server" placeholder="Doğum Tarihi: dd.MM.yyyy"></asp:TextBox>
    ...
    <input  runat="server" name="name" type="text" class="validate[required,custom[onlyLetter],length[0,100]] feedback-input" placeholder="Adres" id="Calisan_Adres" />
      ...
      <p>
          <asp:DropDownList style="margin:auto;"  runat="server" ID="List_Brans">     
            
              <asp:ListItem Enabled="True" Selected="False" >Lütfen Listeden Branş Seçiniz</asp:ListItem>
      ...
      <p class="text">
        <textarea  runat="server" maxlength="260"  style="height:150px; margin-left:auto;" name="text" class="validate[required,length[6,300]] feedback-input" id="hakkinda_Calisan" placeholder="Çalışan Hakkında"></textarea>
      </p>
